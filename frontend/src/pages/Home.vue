    <template #body-content>
      <div class="text-base">
        <div class="flex flex-col gap-4">
          ...
          style="backdrop-filter: blur(3px);background-color: rgba(255, 255, 255, 0.29);border: 2px solid white !important;padding-bottom:0!important;margin: 10px;border-radius: 21px;box-shadow: 0 0 1px 0px rgba(0, 0, 0, 0.39);">
            <Avatar
              size="3xl"
              class="h-12 w-12"
